...
CLOVER will then make predictions and output the classification map and parameter predictions as individual FITS files.  In total, up to eight files are generated:
